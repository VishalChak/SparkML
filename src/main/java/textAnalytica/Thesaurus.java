...
public class Thesaurus {
	...
	/**
	 * Constructs a thesauraus from the given file. The file is expected to be
	 * formatted in parts of the form word synonyms (one per line) [linebreak]
	 * 
	 * @param file
	 *            the location of the saved thesaurus
	 */
	 ...
	 * @return list of synonyms, linebreak-separated. If none, returns an empty
	 *         string.
	 */
	...
	public static void main(String[] args) throws FileNotFoundException {
		Thesaurus thesaurus = new Thesaurus("D:\\Vishal\\CS-51-Final-Project\\thesaurus.txt");
//		
//		System.out.println(thesaurus.map.size());
		String lookup = thesaurus.lookup("circularity");
